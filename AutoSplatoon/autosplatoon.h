...
private:
    ...
    QVector<QString> planComponentGreedy(QPoint start, const Component& comp, const QVector<QVector<bool>>& mask, int& curRow, int& curCol, QVector<QVector<bool>>& visitedGlobal);
